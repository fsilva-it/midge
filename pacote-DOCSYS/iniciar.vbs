...
If Not jaAberto Then
    ...
    If Not jaAberto Then
        ...
        ' critica (MS_TRAVA) procurando a janela de erro. Se o erro
        ...
        For tentativa = 1 To MAX_TENTATIVAS
            ...
            ' Fase critica: durante MS_TRAVA, procura a janela de erro
            ' de colisao a cada 1s (AppActivate acha por titulo).
            Dim tCrit, colidiu
            tCrit = 0
            colidiu = False
            Do While tCrit < MS_TRAVA
            ...
            ' Colisao: mata a instancia travada desta sessao e refaz
            Log "COLISAO detectada (tentativa " & tentativa & ") - refazendo"
            MatarAppNaSessao
            Set exApp = Nothing
            WScript.Sleep 4000
        Next
        ...
        ' Colisao persistiu apos todas as tentativas: NAO deixa a
        ' sessao presa numa tela travada - limpa e desloga.
        If Not abriuOk Then
            Log "FALHA: colisao persistiu apos " & MAX_TENTATIVAS & " tentativas - logoff"
            MatarAppNaSessao
            If (UCase(NomeSessao()) <> "CONSOLE") And (InStr(NomeSessao(), "%") = 0) Then
